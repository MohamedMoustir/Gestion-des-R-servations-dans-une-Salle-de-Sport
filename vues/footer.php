...
<footer class="bg-gradient-to-r from-[#00293b] via-[#00296b] to-[#00293b] py-12 sm:px-16 max-sm:px-8 font-sans tracking-wide">
      <div class="max-w-2xl mx-auto text-center">
        <div class="bg-[#fff] flex p-1 rounded-full text-left mt-4">
          <input type='email' placeholder='Enter your email' class="w-full outline-none bg-transparent text-[15px] pl-4" />
          <button type='button'
            class="bg-[#00296b] text-white text-[15px] rounded-full px-4 py-2.5 tracking-wide">Subscribe</button>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        <div class="lg:col-span-2">
          ...
          <p class="text-gray-300 mb-2 text-[15px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
      ...
      <p class='text-gray-300 text-[15px] mt-10'>© ReadymadeUI. All rights reserved.</p>
    </footer>
</body>
</html>